        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="?mod=blogger&act=create" method="POST" role="form" enctype="multipart/form-data">
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" required id="exampleFirstName" name="name" placeholder="First Name">
                  </div>
                </div>
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" required id="exampleInputEmail" name="email" placeholder="Email Address">
                </div>
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="password" class="form-control form-control-user" required id="exampleInputPassword" name="password" placeholder="Password">
                  </div>
                </div>
              ...
              <div class="text-center">
                <a href="?mod=blogger&act=login" class="btn btn-primary">Back</a>
              </div>
            </div>
          </div>
        </div>
